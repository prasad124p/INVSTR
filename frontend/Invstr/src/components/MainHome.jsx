    ...
    <div>
      ...
      <div>
        <div className=' flex justify-center gap-10'>
            <div className=' w-80 max-w-xs px-10 py-10 bg-amber-50 flex flex-col justify-between rounded-2xl shadow-md'>
                ...
                <div className="group flex items-center text-blue-700 mb-2 cursor-pointer" onClick={()=>handleGetStarted("innovator")}>
                    <span className='translation-colors duration-200 group-hover:text-blue-800 group-hover:scale-120'>Get Started</span>
            ...
            <div className='w-80 flex flex-col justify-between max-w-xs px-10 py-10 bg-amber-50  rounded-2xl shadow-md'>
